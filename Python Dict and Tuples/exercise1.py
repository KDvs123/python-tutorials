...
# add: if user input add then it should further ask 
# for a country name to add. 
# If country already exist in our 
# dataset then it should print that it 
# exist and do nothing. 
# If it doesn't then it asks for population 
# and add that new country/population in our 
...
# remove: when user inputs remove it 
# should ask for a country to remove. 
# If country exist in our dictionary 
# then remove it and print new dictionary
#  using format shown above in (a). 
...
# he or she wants to query. When user inputs
#  that country it will print population of that country.
