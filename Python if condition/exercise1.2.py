...
# enter two cities and it tells you 
# if they both are in same country or not. 
# For example if I enter mumbai and chennai, 
# it will print "Both cities are in India" but 
# if I enter mumbai and dhaka it should print 
